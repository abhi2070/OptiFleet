...
export const timewindowCompletion: TbEditorCompletion = {
  ...
  meta: 'property',
  type: '<a href="https://optifleet.com>Timewindow</a>',
  children: {
    displayValue: {
    ...
    realtime: {
      ...
      meta: 'property',
      type: '<a href="https://optifleet.com">IntervalWindow</a>',
      children: {
        interval: {
    ...
    history: {
      ...
      meta: 'property',
      type: '<a href="https://optifleet.com">HistoryWindow</a>',
      children: {
        historyType: {
        ...
        fixedTimewindow: {
          ...
          meta: 'property',
          type: '<a href="https://optifleet.com">FixedWindow</a>',
          children: {
            startTimeMs: {
    ...
    aggregation: {
      ...
      meta: 'property',
      type: '<a href="https://optifleet.com">Aggregation</a>',
      children: {
        interval: {
        ...
        type: {
          ...
          meta: 'property',
          type: '<a href="https://optifleet.com">AggregationType</a>'
        },
        limit: {
...
export const widgetContextCompletions: TbEditorCompletions = {
  ctx: {
    ...
    meta: 'object',
    type: '<a href="https://optifleet.com">WidgetContext</a>',
    children: {
      ...{
        $container: {
        ...
        $scope: {
          ...
          meta: 'property',
          type: '<a href="https://optifleet.com">IDynamicWidgetComponent</a>'
        },
        width: {
        ...
        widgetConfig: {
          ...
          meta: 'property',
          type: '<a href="https://optifleet.com">WidgetConfig</a>',
          children: {
            title: {
            ...
            legendConfig: {
              ...
              meta: 'property',
              type: '<a href="https://optifleet.com">LegendConfig</a>',
              children: {
                position: {
                  description: 'Legend position. Possible values: <code>\'top\', \'bottom\', \'left\', \'right\'</code>',
                  meta: 'property',
                  type: '<a href="https://optifleet.com">LegendPosition</a>',
                },
                direction: {
                  description: 'Legend direction. Possible values: <code>\'column\', \'row\'</code>',
                  meta: 'property',
                  type: '<a href="https://optifleet.com">LegendDirection</a>',
                },
                showMin: {
            ...
            alarmSource: {
              ...
              meta: 'property',
              type: '<a href="https://optifleet.com">Datasource</a>'
            },
            alarmSearchStatus: {
              description: 'Configured default alarm search status for alarm widget type.',
              meta: 'property',
              type: '<a href="https://optifleet.com">AlarmSearchStatus</a>'
            },
            ...
            datasources: {
              ...
              meta: 'property',
              type: 'Array&lt;<a href="https://optifleet.com">Datasource</a>&gt;'
            }
          }
        },
        settings: {
          description: 'Widget settings containing widget specific properties according to the defined <a href="https://optifleet.com">settings json schema</a>',
          meta: 'property',
          type: 'object'
        },
        datasources: {
        ...
        data: {
          ...
          meta: 'property',
          type: 'Array&lt;<a href="https://optifleet.com">DatasourceData</a>&gt;'
        },
        timeWindow: {
          description: 'Current widget timewindow (applicable for timeseries widgets).',
          meta: 'property',
          type: '<a href="https://optifleet.com">WidgetTimewindow</a>'
        },
        units: {
          description: 'Optional property defining units text of values displayed by widget. Useful for simple widgets like cards or gauges.',
          meta: 'property',
        ...
        currentUser: {
          ...
          meta: 'property',
          type: '<a href="https://optifleet.com">AuthUser</a>',
          children: {
            sub: {
            ...
            authority: {
              ...
              meta: 'property',
              type: '<a href="https://optifleet.com">Authority</a>'
            }
          }
        },
        hideTitlePanel: {
        ...
        defaultSubscription: {
          ...
          meta: 'property',
          type: '<a href="https://optifleet.com">IWidgetSubscription</a>'
        },
        timewindowFunctions: {
          ...
          meta: 'property',
          type: '<a href="https://optifleet.com">TimewindowFunctions</a>',
          children: {
            onUpdateTimewindow: {
        ...
        controlApi: {
          ...
          meta: 'property',
          type: '<a href="https://optifleet.com">RpcApi</a>',
          children: {
            sendOneWayCommand: {
        ...
        actionsApi: {
          ...
          meta: 'property',
          type: '<a href="https://optifleet.com">WidgetActionsApi</a>',
          children: {
            getActionDescriptors: {
              ...
              return: {
                ...
                type: 'Array&lt;<a href="https://optifleet.com">WidgetActionDescriptor</a>&gt;'
              }
            },
            handleWidgetAction: {
              ...
              args: [
                ...
                },
                {
                  ...
                  type: '<a href="https://optifleet.com">WidgetActionDescriptor</a>'
                },
                {
                  name: 'entityId',
        ...
        stateController: {
          ...
          meta: 'property',
          type: '<a href="https://optifleet.com">IStateController</a>',
          children: {
            openState: {
              ...
              args: [
                ...
                },
                {
                  ...
                  type: '<a href="https://optifleet.com">StateParams</a>',
                  optional: true
                },
                {
              ...
              args: [
                {
                  ...
                  type: 'Array <a href="https://optifleet.com">StateObject</a>',
                },
                {
                  name: 'openRightLayout',
                  description: 'An optional boolean argument to force open right dashboard layout if present in mobile view mode.',

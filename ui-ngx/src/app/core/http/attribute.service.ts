...
export class AttributeService {
  ...
  public getDeviceTimeseriesLatestById(entityId: string, config?: RequestConfig): Observable<TimeseriesData> {
    return this.http.get<TimeseriesData>(`/api/plugins/telemetry/DEVICE/${entityId}/values/timeseries`, defaultHttpOptionsFromConfig(config));
  }

  public getTimeseriesKeyById(entityType: string, entityId: string, config?: RequestConfig): Observable<Array<string>> {
    return this.http.get<Array<string>>(`/api/plugins/telemetry/${entityType}/${entityId}/keys/timeseries`, defaultHttpOptionsFromConfig(config));
  }

  public getAllTimeseries(entityType: string, entityId: string, keys: Array<string>, startTime: number, endTime: number, config?: RequestConfig): Observable<Array<string>> {
    return this.http.get<Array<string>>(`/api/plugins/telemetry/${entityType}/${entityId}/values/timeseries?keys=${keys.join(',')}&startTs=${startTime}&endTs=${endTime}`, defaultHttpOptionsFromConfig(config));
  }

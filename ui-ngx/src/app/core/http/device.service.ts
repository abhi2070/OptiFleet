...
export class DeviceService {
  ...
  public getAllIdByDeviceType(deviceType: string, config?: RequestConfig): Observable<DeviceIds> {
    return this.http.get<DeviceIds>(`/api/device/allId/${deviceType}`, defaultHttpOptionsFromConfig(config));
  }

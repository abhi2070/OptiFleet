...
export class CustomersTableConfigResolver implements Resolve<EntityTableConfig<Customer>> {
  ...
  constructor(private customerService: CustomerService,
    ...
    this.config.cellActionDescriptors.push(
      ...
      },
      {
        ...
        nameFunction: (customer) => customer.additionalInfo && customer.additionalInfo.isPublic
  ...
  manageCustomerUsers($event: Event, customer: Customer) {
    ...
    this.router.navigateByUrl(`clients/${customer.id.id}/users`);
  }
  ...
  manageCustomerAssets($event: Event, customer: Customer) {
    ...
    this.router.navigateByUrl(`clients/${customer.id.id}/assets`);
  }
  ...
  manageCustomerDevices($event: Event, customer: Customer) {
    ...
    this.router.navigateByUrl(`clients/${customer.id.id}/devices`);
  }
  ...
  manageCustomerDashboards($event: Event, customer: Customer) {
    ...
    this.router.navigateByUrl(`clients/${customer.id.id}/dashboards`);
  }
  ...
  manageCustomerEdges($event: Event, customer: Customer) {
    ...
    this.router.navigateByUrl(`clients/${customer.id.id}/edgeInstances`);
  }

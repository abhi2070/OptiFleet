...
export class DeviceProfilesTableConfigResolver implements Resolve<EntityTableConfig<DeviceProfile>> {
  ...
  constructor(private deviceProfileService: DeviceProfileService,
    ...
    this.config.columns.push(
      ...
      new EntityTableColumn<DeviceProfile>('type', 'device-profile.type', '20%', (deviceProfile) => this.translate.instant(deviceProfileTypeTranslationMap.get(deviceProfile.type))),
      new EntityTableColumn<DeviceProfile>('transportType', 'device-profile.transport-type', '20%', (deviceProfile) => this.translate.instant(deviceTransportTypeTranslationMap.get(deviceProfile.transportType))),

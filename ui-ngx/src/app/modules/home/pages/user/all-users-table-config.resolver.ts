...
@Injectable()
export class AllUsersTableConfigResolver implements Resolve<EntityTableConfig<User>> {
    ...
    constructor(private store: Store<AppState>,
        ...
        this.config.deleteEnabled = (user) => user && (!user.additionalInfo || !user.additionalInfo.isPublic);
        this.config.detailsReadonly = (user) => user && user.additionalInfo && user.additionalInfo.isPublic;
    }

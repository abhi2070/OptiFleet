...
public class ControllerConstants {
    ...
    protected static final String DEVICE_PROFILE_TYPE = "deviceType";
    ...
    protected static final String FORM_ID = "From ID";
    protected static final String FORM_TYPE = "From Type";
    protected static final String TO_ID = "To ID";
    ...
    protected static final String DEVICE_TYPE_PARAM_DESCRIPTION = "A string value representing the device type. For example, 'indoor'";
    ...
    protected static final String INTEGRATION_PROFILE_ID_PARAM_DESCRIPTION = "A string value representing the integration profile id. For example, '784f394c-42b6-435a-983c-b7beff2784f9'";
    protected static final String DATACONVERTER_ID_PARAM_DESCRIPTION = "A string value representing the data id. For example, '784f394c-42b6-435a-983c-b7beff2784f9'";
    ...
    protected static final String SCHEDULER_ID_PARAM_DESCRIPTION = "A string value representing the scheduler id. For example, '784f394c-42b6-435a-983c-b7beff2784f9'";
    ...
    protected static final String INTEGRATION_TYPE_DESCRIPTION = "Integration type";
    protected static final String DATACONVERTER_TYPE_DESCRIPTION = "Data Converter type";
    protected static final String SCHEDULER_TYPE_DESCRIPTION = "Scheduler type";
    ...
    protected static final String INTEGRATION_TEXT_SEARCH_DESCRIPTION = "The case insensitive 'substring' filter based on the integration name.";
    protected static final String DATACONVERTER_TEXT_SEARCH_DESCRIPTION = "The case insensitive 'substring' filter based on the asset name.";
    protected static final String SCHEDULER_TEXT_SEARCH_DESCRIPTION = "The case insensitive 'substring' filter based on the scheduler name.";
    ...
    protected static final String REPORT_TEXT_SEARCH_DESCRIPTION = "The case insensitive 'substring' filter based on the report title.";
    protected static final String DRIVER_TEXT_SEARCH_DESCRIPTION = "The case insensitive 'substring' filter based on the driver title.";
    protected static final String TRIP_TEXT_SEARCH_DESCRIPTION = "The case insensitive 'substring' filter based on the trip title.";
    ...
    protected static final String DATA_CONVERT_TEXT_SEARCH_DESCRIPTION = "The case insensitive 'substring' filter based on the data convert name.";
    ...
    protected static final String REPORT_SORT_PROPERTY_ALLOWABLE_VALUES = "createdTime, name, type";
    protected static final String DRIVER_SORT_PROPERTY_ALLOWABLE_VALUES = "createdTime, name, status";
    protected static final String TRIP_SORT_PROPERTY_ALLOWABLE_VALUES = "createdTime, name, status";
    ...
    protected static final String DATA_CONVERT_SORT_PROPERTY_ALLOWABLE_VALUES = "createdTime, name, description, isDefault";
    protected static final String ASSET_SORT_PROPERTY_ALLOWABLE_VALUES = "createdTime, name, type, label, customerTitle";
    protected static final String INTEGRATION_SORT_PROPERTY_ALLOWABLE_VALUES = "createdTime, name, type, label, customerTitle";
    protected static final String DATACONVERTER_SORT_PROPERTY_ALLOWABLE_VALUES = "createdTime, name, type, label, customerTitle";
    protected static final String SCHEDULER_SORT_PROPERTY_ALLOWABLE_VALUES = "createdTime, name, type, label, customerTitle";
    ...
    protected static final String DEVICE_TYPES_DESCRIPTION = "Device type is an type of device use to get available id for devices";
    ...
    protected static final String DATACONVERTER_INFO_DESCRIPTION = "DataConverter Info is an extension of the default DataConverter object that contains information about the assigned customer name. ";
    protected static final String SCHEDULER_INFO_DESCRIPTION = "Scheduler Info is an extension of the default Scheduler object that contains information about the assigned customer name. ";
    ...
    protected static final String DATA_CONVERT_INFO_DESCRIPTION = "Data Convert Info is a lightweight object that includes main information about Data Convert. ";
    ...
    protected static final String ROLES_ID_PARAM_DESCRIPTION = "A string value representing the roles id. For example, '784f394c-42b6-435a-983c-b7beff2784f9'";
    protected static final String ROLES_TYPE_DESCRIPTION = "Roles type";
    protected static final String ROLES_TEXT_SEARCH_DESCRIPTION = "The case insensitive 'substring' filter based on the role name.";
    protected static final String ROLES_SORT_PROPERTY_ALLOWABLE_VALUES = "createdTime, name, type, label, customerTitle";
    protected static final String ROLES_INFO_DESCRIPTION = "Role Info is an extension of the default role object that contains information about the assigned customer name. ";
    protected static final String ROLES_NAME_DESCRIPTION = "A string value representing the role name.";

//    protected static final String RESOURCE_INCLUDE_SYSTEM_IMAGES_DESCRIPTION = "Use 'true' to include system images. Disabled by default. Ignored for requests by users with system administrator authority.";
    protected static final String VEHICLE_ID_PARAM_DESCRIPTION = "A string value representing the vehicle id. For example, '784f394c-42b6-435a-983c-b7beff2784f9'";
    protected static final String VEHICLE_TYPE_DESCRIPTION = "Vehicle type";
    protected static final String VEHICLE_TEXT_SEARCH_DESCRIPTION = "The case insensitive 'substring' filter based on the vehicle name.";
    protected static final String VEHICLE_SORT_PROPERTY_ALLOWABLE_VALUES = "createdTime, name, type, label, customerTitle";
    protected static final String VEHICLE_INFO_DESCRIPTION = "Vehicle Info is an extension of the default role object that contains information about the assigned customer name. ";
    protected static final String VEHICLE_NUMBER_DESCRIPTION = "A string value representing the vehicle number.";
    ...
    protected static final String INTEGRATION_NAME_DESCRIPTION = "A string value representing the Integration name.";

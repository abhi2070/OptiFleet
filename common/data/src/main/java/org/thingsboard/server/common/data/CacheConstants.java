...
public class CacheConstants {
    ...
    public static final String INTEGRATION_CACHE = "integrations";
    public static final String SCHEDULER_CACHE = "schedulers";
    ...
    public static final String DATACONVERTER_CACHE = "dataConverter";

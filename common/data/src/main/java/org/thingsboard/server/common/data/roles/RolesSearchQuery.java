...
public class RolesSearchQuery {
    ...
    @ApiModelProperty(position = 1, value = "Type of the relation between root entity and roles (e.g. 'Contains' or 'Manages').")
    private String relationType;
    @ApiModelProperty(position = 2, value = "Array of roles types to filter the related entities (e.g. 'Building', 'Vehicle').")
    ...
    public EntityRelationsQuery toEntitySearchQuery() {
        ...
        query.setFilters(
                Collections.singletonList(new RelationEntityTypeFilter(relationType == null ? EntityRelation.CONTAINS_TYPE : relationType,
                        Collections.singletonList(EntityType.ROLES))));
        return query;
    }
}

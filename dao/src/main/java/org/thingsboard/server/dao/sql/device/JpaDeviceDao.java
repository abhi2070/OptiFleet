...
public class JpaDeviceDao extends JpaAbstractDao<DeviceEntity, Device> implements DeviceDao {
    ...
    @Override
    public DeviceInfo findDeviceInfoById(UUID deviceId) {
        return DaoUtil.getData(deviceRepository.findDeviceInfoById(deviceId));
    }

    @Override
    public List<String> findAllIdByDeviceType(String type) {
        return deviceRepository.findDeviceIdsByType(type);
    }

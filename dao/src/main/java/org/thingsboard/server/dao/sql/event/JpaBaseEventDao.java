...
public class JpaBaseEventDao implements EventDao {
    ...
    private void init() {
        ...
        repositories.put(EventType.DEBUG_INTEGRATION, errorEventRepository);
        ...
        if (eventFilter.isNotEmpty()) {
            switch (eventFilter.getEventType()) {
                ...
                case DEBUG_INTEGRATION:
                    return findEventByFilter(tenantId, entityId, (IntegrationEventFilter) eventFilter, pageLink);
                case STATS:
        ...
        if (eventFilter.isNotEmpty()) {
            switch (eventFilter.getEventType()) {
                ...
                case ERROR:
                    ...
                    break;
                case DEBUG_INTEGRATION:
                    removeEventsByFilter(tenantId, entityId, (IntegrationEventFilter) eventFilter, startTime, endTime);
                    break;
                case STATS:
    ...
    private void removeEventsByFilter(UUID tenantId, UUID entityId, IntegrationEventFilter eventFilter, Long startTime, Long endTime) {
        errorEventRepository.removeEvents(
                tenantId,
                entityId,
                startTime,

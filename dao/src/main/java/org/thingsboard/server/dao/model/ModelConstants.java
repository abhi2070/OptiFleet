...
public class ModelConstants {
    ...
    public static final String DATACONVERTER_TABLE_NAME = "data_converter";
    public static final String DATACONVERTER_TENANT_ID_PROPERTY = TENANT_ID_PROPERTY;
    public static final String DATACONVERTER_NAME_PROPERTY = "name";
    public static final String DATACONVERTER_TYPE_PROPERTY = "type";
    public static final String DATACONVERTER_DEBUG_MODE = "debug_mode";
    public static final String DATACONVERTER_SCRIPTLANG_PROPERTY = "script_lang";
    public static final String DATACONVERTER_PAYLOAD_PROPERTY = "payload";
    public static final String DATACONVERTER_UPDATE_ONLY_KEYS = "update_Only_Keys";
    public static final String DATACONVERTER_METADATA = "metadata";
    public static final String DATACONVERTER_DESCRIPTION = "description";
    public static final String DATACONVERTER_FUNCTION_DECODER = "function_Decoder";
    public static final String DATACONVERTER_FUNCTION_DECODER_JAVASCRIPT = "function_Decoder_Javascript";
    public static final String DATACONVERTER_KEYS_LIST = "key_list";
    public static final String DATACONVERTER_ADDITIONAL_INFO_PROPERTY = ADDITIONAL_INFO_PROPERTY;
    public static final String DATACONVERTER_CONFIGURATION = "configuration";
    ...
    public static final String SCHEDULER_TENANT_ID_PROPERTY = TENANT_ID_PROPERTY;
    public static final String SCHEDULER_NAME_PROPERTY = "name";
    public static final String SCHEDULER_REPORT_NAME_PATTERN_PROPERTY = "reportNamePattern";
    public static final String SCHEDULER_REPORT_TYPE_PROPERTY = "reportType";
    public static final String SCHEDULER_TO_ADDRESS_PROPERTY = "toAddress";
    public static final String SCHEDULER_BCC_PROPERTY = "bcc";
    public static final String SCHEDULER_CC_PROPERTY = "cc";
    public static final String SCHEDULER_SUBJECT_PROPERTY = "subject";
    public static final String SCHEDULER_SCHEDULE_PROPERTY = "schedule";
    public static final String SCHEDULER_REPEAT_PROPERTY = "repeat";
    public static final String SCHEDULER_BODY_PROPERTY = "body";
    public static final String SCHEDULER_TIMEZONE_PROPERTY = "timezone";
    public static final String SCHEDULER_START_PROPERTY = "start";
    public static final String SCHEDULER_END_DATE_PROPERTY = "endDate";
    public static final String SCHEDULER_REPEAT_SCHEDULER = "repeatSchedule";
    public static final String SCHEDULER_REPEAT_ACTIVE = "active";
    public static final String SCHEDULER_REPORT_CATEGORY = "reportCategory";
    public static final String SCHEDULER_REPORT_AVAILABLE = "reportAvailable";
    public static final String SCHEDULER_ADDITIONAL_INFO_PROPERTY = ADDITIONAL_INFO_PROPERTY;
    ...
    public static final String INTEGRATION_CUSTOMER_ID_PROPERTY = CUSTOMER_ID_PROPERTY;
    public static final String INTEGRATION_NAME_PROPERTY = "name";
    public static final String INTEGRATION_TYPE_PROPERTY = "type";
    public static final String INTEGRATION_ENABLE_INTEGRATION = "enable_integration";
    public static final String INTEGRATION_DEBUG_MODE = "debug_mode";
    public static final String INTEGRATION_ALLOW_CREATE_DEVICE_OR_ASSETS = "allow_create_device_or_assets";
    public static final String INTEGRATION_UPLINK_NAME = "Uplink_Name";
    public static final String INTEGRATION_UPLINK_DEBUG_MODE = "Uplink_Debug_Mode";
    public static final String INTEGRATION_UPLINK_DATA_CONVERTER_NAME = "uplink_Data_Converter_Name";
    public static final String INTEGRATION_DOWNLINK_NAME = "downlink_Name";
    public static final String INTEGRATION_DOWNLINK_DEBUG_MODE = "downlink_Debug_Mode";
    public static final String INTEGRATION_DOWNLINK_DATA_CONVERTER_NAME = "downlink_Data_Converter_Name";
    public static final String INTEGRATION_HOST = "host";
    public static final String INTEGRATION_PORT = "port";
    public static final String INTEGRATION_ENABLE_SSL = "enable_SSL";
    public static final String INTEGRATION_PASSWORD = "password";
    public static final String INTEGRATION_USERNAME = "username";
    public static final String INTEGRATION_FILE = "file";
    public static final String INTEGRATION_TOPIC_FILTERS = "topic_filter";
    /**
     * Roles constants.
     */

    public static final String ROLES_TABLE_NAME = "roles";
    public static final String ROLES_TENANT_ID_PROPERTY = TENANT_ID_PROPERTY;
    public static final String ROLES_CUSTOMER_ID_PROPERTY = CUSTOMER_ID_PROPERTY;
    public static final String ROLES_NAME_PROPERTY = "name";
    public static final String ROLES_TYPE_PROPERTY = "type";
    //    public static final String ROLES_LABEL_PROPERTY = "label";
    public static final String ROLES_ADDITIONAL_INFO_PROPERTY = ADDITIONAL_INFO_PROPERTY;

    /**
     * Vehicle constants.
     */

    public static final String VEHICLE_TABLE_NAME = "vehicle_store";
    public static final String VEHICLE_TENANT_ID_PROPERTY = TENANT_ID_PROPERTY;
    public static final String VEHICLE_NUMBER_PROPERTY = "vehicle_number";
    public static final String VEHICLE_TYPE_PROPERTY = "type";
    public static final String VEHICLE_NEXT_SERVICE_PROPERTY = "next_service" ;
    public static final String VEHICLE_STATUS_PROPERTY = "status";
    public static final String VEHICLE_DEVICE_PROPERTY = "device";
    public static final String VEHICLE_RC_PROPERTY = "registration_certificate";
    public static final String VEHICLE_INSURANCE_PROPERTY = "insurance_certificate";
    public static final String VEHICLE_PUC_PROPERTY = "puc_certificate";
    public static final String VEHICLE_REQUIRED_PERMITS_PROPERTY = "required_permits";
    ...
    public static final String REPORT_ASSIGNED_CUSTOMERS_PROPERTY = "assigned_customers";
    public static final String REPORT_NAME = NAME_PROPERTY;
    public static final String REPORT_TYPE_PROPERTY = "type";
    public static final String REPORT_DESCRIPTION_PROPERTY = "description";
    public static final String REPORT_DEVICES_PROPERTY = "devices";
    public static final String REPORT_TELEMETRY_KEYS_PROPERTY = "telemetry_keys";

    /**
     * Driver constants
     */
    public static final String DRIVER_TABLE_NAME = "driver";
    public static final String DRIVER_TENANT_ID_PROPERTY = TENANT_ID_PROPERTY;
    public static final String DRIVER_NAME = NAME_PROPERTY;
    public static final String DRIVER_STATUS = "status";
    public static final String DRIVER_GENDER = "gender";
    public static final String DRIVER_SERVICE_START_DATE = "service_start_date";
    public static final String DRIVER_DATE_OF_BIRTH = "date_of_birth";
    public static final String DRIVER_DRIVING_LICENSE_NUMBER = "driving_license_number";
    public static final String DRIVER_DRIVING_LICENSE_VALIDITY = "driving_license_validity";
    public static final String DRIVER_PROFILE_PHOTO = "profile_photo";
    public static final String DRIVER_DRIVING_LICENSE_DOCUMENT = "driving_license_document";
    ...
    public static final String TRIP_TENANT_ID_PROPERTY = TENANT_ID_PROPERTY;
    public static final String TRIP_NAME = NAME_PROPERTY;
    ...
    public static final String TRIP_VEHICLE_TYPE = "vehicle_type";
    public static final String TRIP_ASSIGNED_VEHICLE = "assigned_vehicle";
    public static final String TRIP_ASSIGNED_DRIVER_ID = "assigned_driver_id";
    public static final String TRIP_DRIVERS = "trip_drivers";
    ...
    protected static final String[] MIN_AGGREGATION_COLUMNS = ArrayUtils.addAll(COUNT_AGGREGATION_COLUMNS, new String[]{min(LONG_VALUE_COLUMN), min(DOUBLE_VALUE_COLUMN), min(BOOLEAN_VALUE_COLUMN), min(STRING_VALUE_COLUMN), min(JSON_VALUE_COLUMN)});
    protected static final String[] MAX_AGGREGATION_COLUMNS = ArrayUtils.addAll(COUNT_AGGREGATION_COLUMNS, new String[]{max(LONG_VALUE_COLUMN), max(DOUBLE_VALUE_COLUMN), max(BOOLEAN_VALUE_COLUMN), max(STRING_VALUE_COLUMN), max(JSON_VALUE_COLUMN)});
    protected static final String[] SUM_AGGREGATION_COLUMNS = ArrayUtils.addAll(COUNT_AGGREGATION_COLUMNS, new String[]{sum(LONG_VALUE_COLUMN), sum(DOUBLE_VALUE_COLUMN)});
